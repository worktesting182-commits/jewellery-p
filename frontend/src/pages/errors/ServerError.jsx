    ...
    <div className="min-h-screen bg-[#F8F6F2] text-black font-sans flex items-center justify-center p-4 sm:p-6 lg:p-8 selection:bg-[#E3C39D] selection:text-black">
      <div className="max-w-md w-full text-center space-y-6 animate-fadeIn">
        ...
        <div className="relative inline-block">
          <div className="w-24 h-24 rounded-full bg-amber-100 border-2 border-amber-300 flex items-center justify-center mx-auto shadow-xl">
            <ServerCrash className="w-12 h-12 text-amber-800" />
          </div>
          <span className="absolute -bottom-2 right-0 px-3 py-1 rounded-full bg-amber-800 text-white font-black text-xs shadow-md uppercase tracking-wider">
            HTTP 500
          </span>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-black/70 font-bold leading-relaxed max-w-sm mx-auto">
            An unexpected error occurred on our server while processing your request. Our technical team has been notified.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          ...
          >
            <RefreshCw className="w-4 h-4 text-[#A68868]" />
            <span>Try Again</span>
          </button>
