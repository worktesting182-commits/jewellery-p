    ...
    <div className="min-h-screen bg-[#F8F6F2] text-black font-sans flex items-center justify-center p-4 sm:p-6 lg:p-8 selection:bg-[#E3C39D] selection:text-black">
      <div className="max-w-md w-full text-center space-y-6 animate-fadeIn">
        ...
        <div className="relative inline-block">
          <div className="w-24 h-24 rounded-full bg-[#E3C39D]/30 border-2 border-[#A68868]/40 flex items-center justify-center mx-auto shadow-xl">
            <Compass className="w-12 h-12 text-[#A68868] animate-spin-slow" />
          </div>
          <span className="absolute -bottom-2 right-0 px-3 py-1 rounded-full bg-[#A68868] text-white font-black text-xs shadow-md uppercase tracking-wider">
            HTTP 404
          </span>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-black/70 font-bold leading-relaxed max-w-sm mx-auto">
            The page or resource you are looking for has been moved, renamed, or does not exist on AuraCraft Jewellery Portal.
          </p>
        </div>
